...
function (_Elixir$Task) {
  ...
  function WebpackTask(name, paths, options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(WebpackTask).call(this, name, null, paths));
    _this.options = options;

    if (_fs.default.existsSync('webpack.config.js')) {
  ...
  _createClass(WebpackTask, [{
    ...
    value: function gulpTask() {
      var jsFiles = (0, _gulpFilter.default)(['**/*.js'], {
        restore: true
      });
